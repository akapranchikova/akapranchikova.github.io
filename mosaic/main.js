const mosaicMarkers = [
    ...
    },
    {
        ...
        popupText: 'Нож ? (неуверена, что он там)'
    },
    {
    ...
    // },
    {
        ...
        popupText: 'Марио (частично разрушена)'
    },
    // {
    ...
    //     popupText: 'Ящерица (частично разрушена)'
    // },
    // {
    ...
    // },
    {
        ...
        popupText: 'Гусь (закрашено)'
    },
    {
        coords: [51.666813611257304, 39.197828024625785],
        popupText: 'Цыплята (частично разрушена)'
    },
    // {
    ...
    // },
    {
        ...
        popupText: 'Таракан (частично разрушена)'
    },
    {
    ...
    //     popupText: 'Взрыв (частично разрушена)',
    // },
    // {
    ...
    },
    {
        ...
        popupText: 'Огонек и трава под ним (у асфальта)',
    },
    {
